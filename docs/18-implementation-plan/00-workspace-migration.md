...
>
> *Those are historical figures for this migration. The suite today is **117 / 0 / 81** — commit
> `63ad3d5` un-ignored three vacuously-gated size assertions, and the DHT field-framing fix added
> two.*
...
- `cargo test` — **112 passed, 0 failed, 84 ignored**, identical to before the move. ✅
  *(Current tree: 117 / 0 / 81 — three were un-ignored later in `63ad3d5`, and two added by the
  DHT field-framing fix.)*
